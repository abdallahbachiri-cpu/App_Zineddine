...
import 'package:cuisinous/screens/dish_form_screen.dart';
...
import 'package:cuisinous/screens/manage_dish_ingredients_screen.dart';
...
import 'package:cuisinous/screens/seller_wallet_screen.dart';
...
import 'package:cuisinous/screens/notification_saller_view.dart';
...
final Map<String, WidgetBuilder> appRoutes = {
  ...
  AppRouter.createStore: (context) => const StoreFormScreen(),
  AppRouter.ingredients: (context) => const IngredientsScreen(),
  AppRouter.dishManagement: (context) => const DishManagementScreen(),
  AppRouter.createDish: (context) => const DishFormScreen(),
  ...
  AppRouter.sellerWallet: (context) => const SellerWalletScreen(),
  AppRouter.sellerStats: (context) => const SellerStatsScreen(),
  ...
  AppRouter.notificationSeller: (context) => const NotificationSallerView(),
};
...
Route<dynamic>? onGenerateRoute(RouteSettings settings) {
  switch (settings.name) {
    ...
    case AppRouter.editStore:
      ...
      return MaterialPageRoute(
        builder: (_) => StoreFormScreen(existingStore: store),
      );

    case AppRouter.editDish:
      final dishId = settings.arguments as String;
      return MaterialPageRoute(
        builder: (_) => DishFormScreen(dishId: dishId),
        fullscreenDialog: true,
      );
    ...
    case AppRouter.notificationSeller:
      return MaterialPageRoute(
        builder: (_) => const NotificationSallerView(),
      );
