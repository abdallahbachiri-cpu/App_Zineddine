...
class _DishDetailScreenState extends State<DishDetailScreen> {
  ...
  late SellerRatingProvider _ratingProvider;

  @override
  void initState() {
    super.initState();
    _dishProvider = context.read<SellerDishProvider>();
    _ratingProvider = context.read<SellerRatingProvider>();
  ...
  Widget build(BuildContext context) {
    return Consumer2<SellerDishProvider, SellerRatingProvider>(
...
class _ManageDishAllergensScreenState extends State<ManageDishAllergensScreen> {
  ...
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<SellerAllergenProvider>().getAllergens();
    });
  }
  ...
  Future<void> _addAllergen() async {
    ...
    final provider = context.read<SellerAllergenProvider>();
      ...
      body: SafeArea(
        ...
        child: GestureDetector(
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                Consumer<SellerAllergenProvider>(
                ...
                SizedBox(
                  width: double.infinity,
                  child: Consumer<SellerAllergenProvider>(
                    builder:
