...
class FoodStoreMapScreen extends StatefulWidget {
  final LatLng? initialLocation;
  final String? selectedStoreId;

  const FoodStoreMapScreen({
    super.key,
  ...
  @override
  State<FoodStoreMapScreen> createState() => _FoodStoreMapScreenState();
}

class _FoodStoreMapScreenState extends State<FoodStoreMapScreen>
