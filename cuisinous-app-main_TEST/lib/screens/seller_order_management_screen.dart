...
class _SellerOrderScreenState extends State<SellerOrderScreen>
  ...
  @override
  void onAutoRefresh() {
    context.read<SellerOrderProvider>().fetchOrders(silent: true);
  }
  ...
  void _scrollListener() {
    if (_scrollController.position.pixels >=
      ...
      context.read<SellerOrderProvider>().loadMoreOrders();
    }
  }
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed:
                () =>
                    context.read<SellerOrderProvider>()
                      ..clearError()
          ...
          return RefreshIndicator(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return _SellerOrderListItem(order: order);
              },
            ),
          );
        },
...
class _SellerOrderListItem extends StatelessWidget {
  ...
  const _SellerOrderListItem({required this.order});
  @override
  Widget build(BuildContext context) {
    return Card(
      color: Colors.white,
...
class _SellerOrderDetailScreenState extends State<SellerOrderDetailScreen> {
  ...
  Future<void> _loadOrder() async {
    if (!mounted) return;
    await context.read<SellerOrderProvider>().getOrderById(widget.orderId);
  }
    ...
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(
          ...
          onPressed: () {
            context.read<SellerOrderProvider>().clearError();
