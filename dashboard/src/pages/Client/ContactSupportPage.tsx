...
const ContactSupportPage: React.FC = () => {
  ...
  if (sent) {
    return (
      <div style={{ maxWidth: 520, textAlign: "center", paddingTop: 48 }}>
        <div style={{ fontSize: 56 }}>✅</div>
        <h2 style={{ fontWeight: 700, fontSize: "1.3rem", marginTop: 16, color: "#059669" }}>
          Message envoyé !
        </h2>
        <p style={{ color: "#6b7280", marginTop: 8 }}>
          Notre équipe vous répondra à l'adresse email enregistrée.
        </p>
        <button
  ...
  return (
    <div style={{ maxWidth: 520 }}>
      <h1 style={{ fontSize: "1.5rem", fontWeight: 700, marginBottom: 6 }}>💬 Contacter le support</h1>
