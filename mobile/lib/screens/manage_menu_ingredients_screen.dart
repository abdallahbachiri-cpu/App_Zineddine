...
class ManageMenuIngredientsScreen extends StatefulWidget {
  final String dishId;
  final bool isEditing;

  const ManageMenuIngredientsScreen({
    super.key,
  ...
  @override
  State<ManageMenuIngredientsScreen> createState() =>
      _ManageMenuIngredientsScreenState();
}

class _ManageMenuIngredientsScreenState
    extends State<ManageMenuIngredientsScreen>
