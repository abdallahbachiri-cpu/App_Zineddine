...
class VendorStoreFormScreen extends StatefulWidget {
  final FoodStore? existingStore;

  const VendorStoreFormScreen({super.key, this.existingStore});

  @override
  State<VendorStoreFormScreen> createState() => _VendorStoreFormScreenState();
}

class _VendorStoreFormScreenState extends State<VendorStoreFormScreen> {
  static const _loggerName = 'VendorStoreFormScreen';
