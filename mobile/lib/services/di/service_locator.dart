...
void _registerCoreDependencies() {
  ...
  getIt.registerLazySingleton<VendorOrderProvider>(
    () => VendorOrderProvider(apiClient: getIt<ApiClient>()),
  );
  ...
  getIt.registerLazySingleton<VendorRatingProvider>(
    () => VendorRatingProvider(apiClient: getIt<ApiClient>()),
  );
  ...
  getIt.registerLazySingleton<VendorAllergenProvider>(
    () => VendorAllergenProvider(apiClient: getIt<ApiClient>()),
  );
...
final List<ChangeNotifierProvider> appProviders = [
  ...
  ChangeNotifierProvider(create: (context) => getIt<VendorOrderProvider>()),
  ChangeNotifierProvider(create: (context) => getIt<CategoryProvider>()),
  ChangeNotifierProvider(
    create: (context) => getIt<PaymentCredentialsProvider>(),
  ),
  ChangeNotifierProvider(create: (context) => getIt<VendorRatingProvider>()),
